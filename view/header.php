...
<body>
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color:#f6b93b;">
    <div class="container">
    <a href="routeur.php"
    ...
    <div class="collapse navbar-collapse"
         id ="navbarNav">
      <button onclick="window.location.href='routeur.php?action=seConnecter'" type="button" class="btn btn-outline-light my-2 mr-3 my-lg-0">Déposer une recette</button>
      <ul class="navbar-nav">
