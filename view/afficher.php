                        ...
                        <div class="row">
                            <div class="col-sm-4 text-center">
                                <h1 class="text-warning mt-4 mb-4">
                                    <b><span id="average_rating"><?php  if ($moyenneCommentaire>0) echo round($moyenneCommentaire, 2); else echo 0; ?> </span> / 5</b>
                                </h1>
                                <h3> <?php  if ($nbCommentaires>0) echo $nbCommentaires; else echo "0"; ?> Avis</h3>
                            </div>
                            <div class="col-sm-4">
                                <p>
                                <div class="progress-label-left"><b>5</b> <i class="fas fa-star text-warning"></i></div>

                                <div class="progress-label-right">(<span><?php if($nb5) echo $nb5; else echo 0; ?></span>)</div>
                                <div class="progress">
                                ...
                                <div class="progress-label-right">(<span><?php if($nb4) echo $nb4; else echo 0; ?></span>)</div>
                                <div class="progress">
                                ...
                                <div class="progress-label-right">(<span><?php if($nb3) echo $nb3; else echo 0; ?></span>)</div>
                                <div class="progress">
                                ...
                                <div class="progress-label-right">(<span><?php if($nb2) echo $nb2; else echo 0; ?></span>)</div>
                                <div class="progress">
                                ...
                                <div class="progress-label-right">(<span><?php if($nb1) echo $nb1; else echo 0; ?></span>)</div>
                                <div class="progress">
