                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-group">
                                <button onclick="window.location.href='index.php?action=afficherRecette&numRecette=<?php echo $lesRecettesUtilisateurs[$key]['numRecette']; ?>'" type="button" class="btn btn-sm btn-outline-secondary ml-1">
                                    Découvrir
                                </button>
                            </div>
                        </div>
